<?php
// ===================================================
// ADMIN — TAMBAH BUKU, form Bootstrap
// ===================================================
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1 p-4">
            <div class="mx-auto" style="max-width: 520px;">
                ...
                <h1 class="h3 mb-4"><i class="bi bi-plus-circle" style="color:#4a2c1d;"></i> Tambah Buku</h1>
                ...
                <form method="POST" action="buku-tambah.php" class="card p-4 shadow-sm border-0">
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-success d-flex align-items-center gap-1"><i class="bi bi-check-lg"></i> Simpan</button>
